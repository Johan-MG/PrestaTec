<%-- 
    Document   : Login
    Created on : 28 nov. 2022, 19:27:59
    Author     : gohan
--%>
...
<%
    ...
    if(request.getSession().getAttribute("errorCode") != null){
        ...
        mensaje += " * Usuario o contraseña incorrectos. </div>";
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="Registro.jsp" class="btn btn-primary py-2 px-4 d-none d-lg-block">Registro</a>
                <small class="px-2"></small>
                <a href="Login.jsp" class="btn btn-primary py-2 px-4 d-none d-lg-block">Inicio de sesión</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="row justify-content-center bg-white mx-0 mb-5">
        <div class="col-lg-6 py-5">
            <div class="row justify-content-center bg-image p-5 my-5">
                ...
                <form id="frmLogin" method="POST" action="srvLogin">
                    <div class="form-row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input name="txtUsuario" type="text" class="form-control bg-light border-0" placeholder="Tu Usuario" style="padding: 30px 20px;">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input name="txtContrasena" type="text" class="form-control bg-light border-0" placeholder="Tu Contraseña" style="padding: 30px 20px;">
                            </div>
                        </div>
                    ...
                    <form class="form-row">
                        ...
                        <div class="container text-center justify-content-center">
                            <button class="btn btn-primary btn-block" type="submit" style="height: 60px;">Acceder</button>
                        </div>
                        <div id="passwordHelpBlock" class="form-text">
                            ¿Aún no tienes cuenta? 
                            <a href="signin.html">Crear una cuenta ahora</a>
                          </div>
                        <%=mensaje%>
                        </form>
                </form>
